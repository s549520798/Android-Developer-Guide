package com.lazylee.apiguidedemo.ui_navigation.widgets;
...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.lazylee.apiguidedemo.ui_navigation.widgets.NewAppWidget";
